...
//        }
    ...
    func register(withUserId userId: String) {
        ...
        UIApplication.shared.windows.first?.rootViewController = AmityCommunityHomePageViewController.make()  //TabbarViewController()
    ...
    func startingPage() -> UIViewController {
        AppManager.shared.register(withUserId: "Krishna")
        return AmityCommunityHomePageViewController.make()
