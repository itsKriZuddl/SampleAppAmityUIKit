...
struct EnvironmentSettingModel: Codable {
    ...
    static func defaultConfig(for environment: EnvironmentType) -> EndpointConfigModel {
        return EndpointConfigModel(apiKey: "b0eaec5d398ef36c4f62851c53001489d55a8ab6bf366a2c", httpEndpoint: AmityRegion.US.httpUrl, socketEndpoint: AmityRegion.US.rpcUrl, mqttEndpoint: AmityRegion.US.mqttHost)
    }
}
